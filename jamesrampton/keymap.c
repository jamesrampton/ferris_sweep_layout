...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_H,    KC_I,    MT(MOD_LALT,KC_E),    MT(MOD_LGUI,KC_A),   TD(DANCE_3),   	KC_D,   MT(MOD_RGUI,KC_S),   MT(MOD_RALT,KC_T),  KC_N,  KC_B,
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_J,   TD(DANCE_2),  TD(DANCE_1), KC_K,   KC_BSPC,  							KC_W,     KC_F,   KC_L,   KC_P,   KC_V,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_ESCAPE,KC_AT    ,LSFT(KC_3)     ,TD(DANCE_31)     ,KC_PERC    ,KC_CIRC    ,KC_AMPR   ,KC_ASTR   ,KC_SEMICOLON   ,KC_BSPC ,
  //----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_TAB,KC_EQL    ,LALT(KC_RIGHT_BRACKET)    ,LALT(LSFT(KC_RIGHT_BRACKET))    ,TD(DANCE_32)    ,TD(BKSL_HME),LSFT(KC_LBRC),LSFT(KC_RBRC),TD(PIPE_END),KC_ENTER   ,
  //----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_TILD, TD(DANCE_33)   ,LALT(KC_LEFT_BRACKET)   ,LALT(LSFT(KC_LEFT_BRACKET))   ,KC_DQUO   ,KC_LBRC     ,KC_LPRN   ,KC_RPRN   ,KC_RBRC   ,TO(3)   ,
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_MEDIA_EJECT,   KC_KP_ASTERISK, KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_KP_DOT,   KC_0,   KC_1, KC_2, KC_3,    OSM(MOD_RCTL),
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	  TO(0), KC_LGUI,KC_RALT ,TO(2)
  ),

  [3] = LAYOUT(
      TD(DANCE_54),   KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, TD(DANCE_55), LGUI(KC_LEFT_BRACKET),LGUI(LALT(KC_DOWN)),LGUI(LALT(KC_UP)),   LGUI(KC_RIGHT_BRACKET),KC_TRANSPARENT, 
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
     TD(DANCE_58),   KC_MS_BTN2,     KC_MS_WH_UP,    KC_MS_WH_DOWN, KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_ACCEL0,   KC_MS_ACCEL1,   KC_MS_ACCEL2,   OSM(MOD_LCTL), 
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
